...
<% 
			try
			{
				...
				<h4> BOOK ID	-TITLE	-PUBL NAME	-NO OF COPIES	-AUTHOR NAME	-BRANCH ID</h4>
				...
				<% while(rs.next())
				{
						...
						out.println("<br/>");%>
						<p><%=book_Id %>&nbsp&nbsp&nbsp<%=Title %>&nbsp&nbsp&nbsp<%= Publisher_Name %>&nbsp&nbsp&nbsp&nbsp<%=copies %>&nbsp&nbsp&nbsp&nbsp<%=author_name%>&nbsp&nbsp&nbsp&nbsp <%= branch_id %> </p>
